...
/// Opens the "create an open (bookable) slot" dialog (OWNER-195). On confirm it
/// dispatches [ScheduleEvent.openSlotCreated] to [bloc]; the bloc persists the
/// slot with `status = 'open'` so it is immediately visible to customers.
Future<void> showCreateOpenSlotDialog(
  ...
  return showDialog<void>(
    ...
    builder: (_) => _CreateOpenSlotDialog(
      bloc: bloc,
      court: court,
      weekStart: weekStart,
      existing: existing,
...
class _CreateOpenSlotDialog extends StatefulWidget {
  const _CreateOpenSlotDialog({
    required this.bloc,
    required this.court,
  ...
  @override
  State<_CreateOpenSlotDialog> createState() => _CreateOpenSlotDialogState();
}

class _CreateOpenSlotDialogState extends State<_CreateOpenSlotDialog> {
  late DateTime _date;
  late int _hour;
  int _duration = 90;
  ...
  void _submit() {
    ...
    widget.bloc.add(
      ScheduleEvent.openSlotCreated(startAt: _startAt, endAt: _endAt),
    );
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Semantics(
                            label: 'create-open-slot-hour-dropdown',
                ...
                // Info banner — open slot is customer-bookable
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Slot sẽ hiện trên ứng dụng và khách có thể đặt ngay.',
                          style: GoogleFonts.plusJakartaSans(
                            fontSize: 12.5,
                            height: 1.45,
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: Semantics(
                        label: 'create-open-slot-submit-btn',
                        button: true,
                        child: FilledButton(
...
class _DateChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: 'create-open-slot-date-$index',
      button: true,
      selected: selected,
...
class _DurationChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: 'create-open-slot-duration-$minutes',
      button: true,
      selected: selected,
      child: GestureDetector(
        onTap: onTap,
