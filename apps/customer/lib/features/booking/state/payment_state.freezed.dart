...
extension PaymentStatePatterns on PaymentState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case PaymentLoaded() when loaded != null:
        return loaded(_that);
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(String bookingId, String courtName, DateTime slotStart,
            DateTime slotEnd, double totalPrice)?
        loaded,
    ...
    switch (_that) {
      case PaymentLoading() when loading != null:
        return loading();
      case PaymentLoaded() when loaded != null:
        return loaded(_that.bookingId, _that.courtName, _that.slotStart,
            _that.slotEnd, _that.totalPrice);
      case PaymentError() when error != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String bookingId, String courtName,
            DateTime slotStart, DateTime slotEnd, double totalPrice)
        loaded,
...
class PaymentLoaded implements PaymentState {
  ...
  int get hashCode => Object.hash(
      runtimeType, bookingId, courtName, slotStart, slotEnd, totalPrice);
...
/// @nodoc
abstract mixin class $PaymentLoadedCopyWith<$Res>
    implements $PaymentStateCopyWith<$Res> {
  factory $PaymentLoadedCopyWith(
          PaymentLoaded value, $Res Function(PaymentLoaded) _then) =
