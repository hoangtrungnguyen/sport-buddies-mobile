...
extension MapStatePatterns on MapState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case MapLoading() when loading != null:
        return loading(_that);
      case MapLoaded() when loaded != null:
        return loaded(_that);
      case MapError() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case MapLoading() when loading != null:
        return loading();
      case MapLoaded() when loaded != null:
        return loaded(_that.courts, _that.selectedCourt);
      case MapError() when error != null:
...
class MapLoaded implements MapState {
  const MapLoaded(final List<CourtAvailability> courts, {this.selectedCourt})
      : _courts = courts;
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_courts), selectedCourt);
...
abstract mixin class $MapLoadedCopyWith<$Res>
  ...
  @useResult
  $Res call({List<CourtAvailability> courts, CourtAvailability? selectedCourt});
...
class MapError with AppExceptionMixin implements MapState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MapErrorCopyWith<MapError> get copyWith =>
      _$MapErrorCopyWithImpl<MapError>(this, _$identity);
...
/// @nodoc
abstract mixin class $MapErrorCopyWith<$Res>
    implements $MapStateCopyWith<$Res> {
  factory $MapErrorCopyWith(MapError value, $Res Function(MapError) _then) =
      _$MapErrorCopyWithImpl;
  @useResult
  $Res call({String message, StackTrace? stackTrace});
}

/// @nodoc
class _$MapErrorCopyWithImpl<$Res> implements $MapErrorCopyWith<$Res> {
