...
// BlocBuilder wrapping MapCubit) owns the selected state.
...
class _SportEntry {
  ...
  /// Lower-case identifier used in [MapState.selectedSports].
...
///     onSportsChanged: context.read<MapCubit>().filterBySports,
///   ),
/// )
/// ```
///
